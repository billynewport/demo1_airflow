...
secret_manager = K8sSecretManager(namespace='demo1')
...
common_env_vars = [
    ...
    k8s.V1EnvVar(name='DATASURFACE_NAMESPACE', value='demo1'),
]
...
def create_factory_dags_from_database(silent: bool = False, **context):
    ...
    try:
        ...
        merge_db_host = 'host.docker.internal'
        merge_db_port = 5432
